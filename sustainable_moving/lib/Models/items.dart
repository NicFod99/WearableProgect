...
class Catalog {
  ...
  static Catalog vicenzaCatalog() {
    return Catalog(items: [
      PathData(
        name: 'Strade delle 52 gallerie path',
        length: 5700,
        description:
      ...
      PathData(
        name: 'Cima Portule e Cima Larici Path',
        length: 950,
        description:
  ...
  static Catalog veneziaCatalog() {
    return Catalog(items: [
      PathData(
        name: 'Parco di San Giuliano path',
        length: 750,
      ...
      PathData(
        name: 'Parco Alfredo Albanese path',
        length: 500,
      ...
      PathData(
        name: 'Parco delle Rimembranze path',
        length: 550,
